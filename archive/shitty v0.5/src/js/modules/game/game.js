...
import gameGoingWellImg from '../../../assets/img/game_good.png';
import gameOverImg from '../../../assets/img/game_over.png';
import gameWonImg from '../../../assets/img/game_win.gif';
...
function Game() {
    ...
    */
    ...
    this._winGame = function() {
        ...
        _newGameButtonImage.setAttribute('src', gameWonImg);
    ...
    this._loseGame = function() {
        ...
        // Update new game button icon
        _newGameButtonImage.setAttribute('src', gameOverImg);
    ...
    this._newGame = function() {
        ...
        // == or ===?
        if (_newGameButtonImage.getAttribute('src') != gameGoingWellImg) {
            _newGameButtonImage.setAttribute('src', gameGoingWellImg);
